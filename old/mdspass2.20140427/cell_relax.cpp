...
void cell_relax_static()
{
  ...
  if (cell.relax_static_initial) {
    ...
    dxystr = (cell.hmat[0][1]-cell.hmat_p[0][1])/cell.hmat[0][1];
    dyzstr = (cell.hmat[1][2]-cell.hmat_p[1][2])/cell.hmat[1][2]; 
    dzxstr = (cell.hmat[2][0]-cell.hmat_p[2][0])/cell.hmat[2][0];
